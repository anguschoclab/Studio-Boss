  ...
  FATIGUED: [
    {
      ...
      buzzBonus: 10,
      flavorTemplate:
        "An unscripted docuseries retrospective detailing the troubled production and ultimate downfall of the {title} franchise.",
    },
    {
      ...
      buzzBonus: -20,
      flavorTemplate:
        "A cynical, zero-budget IP retention flop designed purely to keep the rights to {title} before they expire.",
    },
    {
      ...
      buzzBonus: -5,
      flavorTemplate:
        "A desperate gimmick interactive special attempting to pull audiences back with a 'choose your own adventure' format.",
    },
  ],
  HEALTHY: [
    {
    ...
    },
    {
      ...
      buzzBonus: 5,
      flavorTemplate:
        "A highly stylized anime spin-off meant to expand the global reach of the {title} universe.",
    },
  ],
  LEGACY: [
    {
      ...
      buzzBonus: 25,
      flavorTemplate:
        "Decades later, the original cast returns to pass the torch to a new generation in this long-awaited continuation.",
    },
    {
      ...
      buzzBonus: 15,
      flavorTemplate:
        'A massive "soft reboot" of a dead legacy IP with extreme risk and a huge budget.',
    },
  ],
};
