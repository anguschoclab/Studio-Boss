...
export function calculateMotivationScores(
  ...
  // ⚡ Bolt Optimization: Replaced Object.entries().forEach with for...in to prevent unnecessary intermediate array allocations and GC spikes during AI motivation calculations.
