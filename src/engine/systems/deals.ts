...
export function offerFirstLookDeal(state: GameState, talentId: string, weeksRemaining: number, // eslint-disable-next-line @typescript-eslint/no-unused-vars
  exclusivity: boolean = true): StateImpact[] {
...
export function packageProject(project: Project, talentIds?: string[], // eslint-disable-next-line @typescript-eslint/no-unused-vars
 agency?: Agency): { packageScore: number, synergies: string[] } {
