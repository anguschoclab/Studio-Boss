...
export const TIME_SLOTS: Record<TimeSlot, TimeSlotConfig> = {
  "8PM": {
    id: "8PM",
    label: "8:00 PM (Family Hour)",
    baseHouseholds: 45,
    primeTimeMultiplier: 1.0,
    demographics: {
      "P2+": 1.0,
      "A18-49": 0.8,
      "A25-54": 0.9,
  ...
  "9PM": {
    id: "9PM",
    label: "9:00 PM (Power Hour)",
    baseHouseholds: 50,
    primeTimeMultiplier: 1.15,
    demographics: {
      "P2+": 1.0,
      "A18-49": 1.2,
      "A25-54": 1.1,
  ...
  "10PM": {
    id: "10PM",
    label: "10:00 PM (Prestige Hour)",
    baseHouseholds: 40,
    primeTimeMultiplier: 1.05,
    demographics: {
      "P2+": 0.9,
      "A18-49": 1.0,
      "A25-54": 1.2,
  ...
  LATE_NIGHT: {
    id: "LATE_NIGHT",
    label: "Late Night (11:30 PM+)",
    baseHouseholds: 20,
    primeTimeMultiplier: 0.6,
    demographics: {
      "P2+": 0.6,
      "A18-49": 1.1,
      "A25-54": 0.8,
  ...
  STREAMING: {
    id: "STREAMING",
    label: "Streaming (On-Demand)",
    baseHouseholds: 60,
    primeTimeMultiplier: 0.85,
    demographics: {
      "P2+": 0.9,
      "A18-49": 1.3,
      "A25-54": 1.0,
...
// --- Demographic System ---
export type NielsenDemographic =
  "P2+" | "A18-49" | "A25-54" | "A18-34" | "W18-49" | "M18-49" | "K2-11" | "T12-17";
...
export function calculateNielsenRatings(
  ...
  const timeSlot: TimeSlot = project.nielsenProfile?.timeSlot || assignTimeSlot(project);
  ...
  const midSeasonDip = episodeNumber > 2 && !isFinalWeek ? Math.pow(0.97, episodeNumber - 2) : 1.0;
 ...
 */
export function buildNielsenProfile(
  snapshots: NielsenSnapshot[],
  timeSlot: TimeSlot
): NielsenProfile {
