...
export class ExpenseProcessor {
  ...
  static calculateStudioBurn(level: number, activeProjectsCount: number): number {
    // The Studio Comptroller: Increased base rent to 2M, project penalty to 500k, and levelScale base to 1.8 to aggressively drain passive empires and prevent snowballing.
