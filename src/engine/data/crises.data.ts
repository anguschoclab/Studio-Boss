...
export const CRISIS_POOLS: CrisisTemplate[] = [
  {
    id: "actors_hot_mic",
    description:
      "Your lead actor has been caught on a hot mic making disparaging remarks about the studio's latest streaming platform, calling it 'a digital graveyard for dreams'.",
    options: [
      {
        text: "Force them to issue a groveling apology and do a 48-hour social media takeover.",
        effectDescription:
          "Costs $50k in PR consulting. The actor's ego takes a hit, but the story dies.",
        cashPenalty: 50000,
      },
      {
        text: "Lean into it. Market the film as 'the one the studio didn't want you to see'.",
        effectDescription:
          "Increases buzz by 25, but the studio owner is furious. Lose 10 reputation.",
        buzzPenalty: -25,
  ...
  },
  {
    id: "crisis_1",
    description:
      "The film's primary editor accidentally formatted the main server, losing three weeks of 'impossible to replicate' footage shot on location in the Himalayas.",
    options: [
      {
        text: "Spend a fortune on professional data recovery specialists.",
        effectDescription:
          "Costs $500k. There is a 70% chance it works (represented here as a cost/delay penalty).",
        cashPenalty: 500000,
        weeksDelay: 1,
      },
      {
  ...
  },
  {
    id: "crisis_2",
    description:
      "Your 'visionary' director has demanded an additional $5M to render every strand of hair on a CGI cat that only appears on screen for four seconds.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $200k for animal trainers and a reshoot day. Delays production by 1 week.",
        cashPenalty: 200000,
        weeksDelay: 1,
      },
    ],
  },
  {
    id: "crisis_3",
    description:
      "A rival studio has just announced a near-identical project with a bigger star, scheduled to release on the exact same weekend as yours.",
    options: [
      {
  ...
  },
  {
    id: "crisis_4",
    description:
      "The star's romantic comedy interest has gone public with a devastating breakup—with your movie’s director.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "The film gains 20 buzz but the director and star's relationship is permanently toxic. Lose 10 reputation.",
        buzzPenalty: -20,
        reputationPenalty: 10,
      },
    ],
  },
  {
    id: "crisis_5",
    description:
      "The primary filming location—a historic 14th-century castle—has been haunted by a 'very active' poltergeist that keeps throwing lighting rigs at the crew.",
    options: [
      {
  ...
  },
  {
    id: "crisis_6",
    description:
      "The script for your highly guarded sci-fi epic has been leaked to a popular fan forum, and the ending is being universally mocked.",
    options: [
      {
  ...
  },
  {
    id: "crisis_7",
    description:
      "Your lead actress has decided to pivot to an exclusive 'spiritual wellness' retreat in the middle of principal photography and refuses to check her phone.",
    options: [
      {
  ...
  },
  {
    id: "crisis_8",
    description:
      "During a stunt gone wrong, the film's only hero vehicle—a one-of-a-kind vintage Italian supercar—was driven into a lake.",
    options: [
      {
  ...
  },
  {
    id: "crisis_9",
    description:
      "The studio's highly touted 'carbon neutral' initiative has been exposed as a sham: a local journalist found a secret diesel generator hidden under a pile of bamboo sets.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $100k to replace the caterers. The crew is miserable (lose 5 reputation).",
        cashPenalty: 100000,
        reputationPenalty: 5,
      },
    ],
  },
  {
    id: "crisis_10",
    description:
      "Your 'method' lead actor has refused to wear modern shoes on set, even when out of character, and has now contracted a severe foot infection.",
    options: [
      {
  ...
  },
  {
    id: "crisis_11",
    description:
      "The film's most expensive practical effect—a scale model of London—was accidentally sat on by a tired PA.",
    options: [
      {
  ...
  },
  {
    id: "crisis_12",
    description:
      "Your director has gone 'rogue' and is shooting an experimental, 4-hour documentative cut about the 'nature of craft services', ignoring the original rom-com script.",
    options: [
      {
        text: "Fire the director and bring in a 'studio hack' to finish.",
        effectDescription:
          "Costs $800k in severance and new fees. The film is salvaged but loses all auteur buzz (lose 20 buzz).",
        cashPenalty: 800000,
        buzzPenalty: 20,
      },
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $200k in travel and hotels. Delays production by 1 week as everyone argues.",
        cashPenalty: 200000,
        weeksDelay: 1,
      },
    ],
  },
  {
    id: "crisis_13",
    description:
      "A major religious group has called for a worldwide boycott of the studio because your family-friendly animated film features a 'too realistic' depiction of a demon.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Pivoting the marketing costs $800k. Buzz increases by 40, but you lose family appeal.",
        cashPenalty: 800000,
        buzzPenalty: -40,
      },
      {
  ...
  },
  {
    id: "crisis_14",
    description:
      "Your lead actor just announced their retirement from acting to become a professional competitive eater, effective immediately.",
    options: [
      {
  ...
  },
  {
    id: "crisis_15",
    description:
      "During a night shoot, the crew accidentally 'borrowed' power from a local hospital, causing a brief blackout in the ICU.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $200k in legal fees. Production is frozen for 2 weeks during the investigation.",
        cashPenalty: 200000,
        weeksDelay: 2,
      },
    ],
  },
  {
    id: "crisis_16",
    description:
      "A rogue intern accidentally deleted the only backup of the film's 10-minute climactic sequence.",
    options: [
      {
        text: "Reshoot the sequence.",
        effectDescription:
          "Costs $5M and delays the film by 3 weeks. It will never be as good as the original.",
        cashPenalty: 5000000,
        weeksDelay: 3,
        buzzPenalty: 10,
      },
  ...
  },
  {
    id: "crisis_17",
    description:
      "Your star actor's dog has passed away, and they have declared a 'month of mourning', refusing to leave their bedroom.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "They return, but they are visibly weeping in every scene which serves as a rom-com. Lose 35 buzz.",
        buzzPenalty: 35,
      },
    ],
  },
  {
    id: "crisis_18",
    description:
      "A prominent 'cultural consultant' you hired has gone rogue on TikTok, detailing every single change you made to their traditional story, calling the film 'profoundly offensive'.",
    options: [
      {
  ...
  },
  {
    id: "crisis_19",
    description:
      "Extreme weather has literally blown the rooftop off your primary soundstage, destroying $2M in electronics and ruining your 'rain-free' set.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $500k in rewrites and effects. The plot makes no sense. Lose 20 buzz.",
        cashPenalty: 500000,
        buzzPenalty: 20,
      },
    ],
  },
  {
    id: "crisis_20",
    description:
      "Leaked emails show your lead actor mocking the film's source material, calling the original book 'trash for idiots'.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Buzz increases by 10, but the core fanbase is livid. Lose 25 buzz overall.",
        buzzPenalty: 15,
      },
      {
        text: "Fire them and replace with a CGI character.",
        effectDescription:
          "Costs $5M and delays the film by 6 weeks. The internet is fascinated but confused.",
        cashPenalty: 5000000,
        weeksDelay: 6,
      },
    ],
  },
  {
    id: "crisis_21",
    description:
      "The film's most anticipated action scene—a motorcycle jump onto a moving train—was performed perfectly, but the camera operator forgot to press record.",
    options: [
      {
  ...
  },
  {
    id: "crisis_22",
    description:
      "Your lead actor has decided to go full 'Method' and refuses to break character, communicating only in grunts and throwing their own feces on set.",
    options: [
      {
  ...
  },
  {
    id: "crisis_23",
    description:
      "The film's incredibly expensive, bespoke physical prop—a MacGuffin critical to the plot—was accidentally sold at a local garage sale by a disgruntled PA.",
    options: [
      {
  ...
  },
  {
    id: "crisis_24",
    description:
      "The director of your gritty urban thriller insists on shooting exclusively during 'magic hour', reducing usable filming time to 15 minutes a day.",
    options: [
      {
  ...
  },
  {
    id: "crisis_25",
    description:
      "The studio's highly publicized 'carbon neutral' initiative is a sham, and an investigative journalist just found the massive hidden diesel generators powering the set.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $1.2M in rush infrastructure changes and delays the shoot by 2 weeks.",
        cashPenalty: 1200000,
        weeksDelay: 2,
      },
    ],
  },
  {
    id: "crisis_26",
    description:
      "A prominent supporting actor was just exposed for running a bizarre, multi-level marketing scheme selling 'brain-enhancing' essential oils to their fans.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $200k. The fans realize they are being grifted. Massive 45 buzz penalty.",
        cashPenalty: 200000,
        buzzPenalty: 45,
      },
    ],
  },
  {
    id: "crisis_27",
    description:
      "The film's highly touted 'groundbreaking' CGI monster design was leaked, and the internet unanimously agrees it looks exactly like a popular children's cartoon character.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Audiences don't buy it, and you face a potential lawsuit. Lose 30 buzz and $500k in legal fees.",
        buzzPenalty: 30,
        cashPenalty: 500000,
      },
      {
  ...
  },
  {
    id: "crisis_28",
    description:
      "Your 'visionary' director has demanded that the entire third act be reshot because they 'had a dream where the villain was actually a misunderstood mime'.",
    options: [
      {
  ...
  },
  {
    id: "crisis_30",
    description:
      "The primary VFX studio just declared bankruptcy, taking the only server holding your unrendered CGI assets offline.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $250k. Highly illegal, but you get the files. Lose 10 reputation.",
        cashPenalty: 250000,
        reputationPenalty: 10,
      },
      {
  ...
  },
  {
    id: "crisis_31",
    description:
      "A decade-old tweet from your visionary director has just resurfaced, and it contains some incredibly problematic takes on a beloved cartoon franchise.",
    options: [
      {
  ...
  },
  {
    id: "crisis_32",
    description:
      "An extra managed to smuggle a script onto Reddit, and a 4-hour video essay dismantling your plot holes is currently trending #1 on YouTube.",
    options: [
      {
        text: "Rewrite the final act to subvert their expectations.",
        effectDescription:
          "Costs $800k in emergency rewrites and reshoots. Delays production by 2 weeks.",
        cashPenalty: 800000,
        weeksDelay: 2,
      },
      {
  ...
  },
  {
    id: "crisis_33",
    description:
      "A ransomware syndicate has stolen the director's cut of your highly anticipated blockbuster and is threatening to release it with comic-sans subtitles.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "They leak it. The comic-sans is deeply distracting. Lose 50 buzz and 15 reputation.",
        buzzPenalty: 50,
        reputationPenalty: 15,
      },
      {
        ...
        effectDescription:
          "Costs $100k to set up the 'leak'. The studio loses its theatrical window. Massive financial loss. Lose $5M.",
        cashPenalty: 5100000,
      },
    ],
  },
  {
    id: "crisis_34",
    description:
      "Your lead actor refuses to promote the movie unless the studio funds their side project: a 3-hour black-and-white silent film about crypto-mining.",
    options: [
      {
        text: "Fund the side project.",
        effectDescription:
          "Costs $2M. The vanity project is a disaster, but they do the press tour.",
        cashPenalty: 2000000,
      },
      {
        text: "Cancel their press tour.",
      ...
      },
      {
        ...
        effectDescription:
          "They do the press tour but bad-mouth the film in every interview. Lose 20 buzz and 10 reputation.",
        buzzPenalty: 20,
        reputationPenalty: 10,
      },
    ],
  },
  {
    id: "crisis_35",
    description:
      "The highly-touted practical explosion sequence accidentally ignited a nearby prop warehouse, destroying $500k worth of vintage costumes.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $100k in legal fees. Production is delayed 2 weeks while the set is locked down.",
        cashPenalty: 100000,
        weeksDelay: 2,
      },
      {
  ...
  },
  {
    id: "crisis_36",
    description:
      "Your 'inclusive' historical epic just cast a wildly historically inaccurate lead, and historians on TikTok are destroying the film's credibility.",
    options: [
      {
  ...
  },
  {
    id: "crisis_38",
    description:
      "The star of your romantic comedy is publicly feuding with their co-star. The paparazzi just caught them brawling outside a vegan restaurant.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $1M to sever their contract. Delays the film by 4 weeks to recast.",
        cashPenalty: 1000000,
        weeksDelay: 4,
      },
      {
  ...
  },
  {
    id: "crisis_42",
    description:
      "The movie's lead has been accused of stealing the plot from a wildly popular, self-published fan-fiction blog.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $250k in legal fees. The internet turns against you. Lose 35 buzz.",
        cashPenalty: 250000,
        buzzPenalty: 35,
      },
      {
  ...
  },
  {
    id: "crisis_43",
    description:
      "A rogue marketing intern accidentally tweeted the entire plot twist from the official studio account.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "The internet already screenshotted it. The twist is ruined. Lose 25 buzz.",
        buzzPenalty: 25,
      },
      {
  ...
  },
  {
    id: "crisis_44",
    description:
      "Your lead method actor has fully immersed themselves in their character as an 18th-century cobbler and is refusing to wear modern shoes, perform lines correctly, or acknowledge anyone by their real names.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "They break character, but immediately trash the studio to the press. Lose 30 buzz and 5 reputation.",
        buzzPenalty: 30,
        reputationPenalty: 5,
      },
    ],
  },
  {
    id: "crisis_45",
    description:
      "The primary VFX studio hired for the film has suddenly declared bankruptcy, leaving 80% of your CGI shots unfinished and held hostage by their creditors.",
    options: [
      {
  ...
  },
  {
    id: "crisis_46",
    description:
      "Extremely problematic tweets from your director dating back to 2011 have suddenly resurfaced and are trending globally on social media.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "The internet goes nuclear. The studio's reputation suffers heavily. Lose 35 buzz and 15 reputation.",
        buzzPenalty: 35,
        reputationPenalty: 15,
      },
    ],
  },
  {
    id: "crisis_47",
    description:
      "Your A-list lead actor has been arrested in a foreign country for attempting to smuggle an endangered iguana through customs.",
    options: [
      {
  ...
  },
  {
    id: "crisis_48",
    description:
      "An anonymous hacker group is threatening to leak the unfinished, un-color-graded film unless a $2M ransom is paid in cryptocurrency.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $100k in PR spin. Confuses the public but lessens the blow. Lose 20 buzz.",
        cashPenalty: 100000,
        buzzPenalty: 20,
      },
    ],
  },
  {
    id: "crisis_49",
    description:
      "Your two co-stars have developed a deep, burning hatred for each other and absolutely refuse to film any scenes together.",
    options: [
      {
  ...
  },
  {
    id: "crisis_50",
    description:
      "The crew has walked off the set, claiming the historic location is severely haunted after three lighting rigs collapsed under mysterious circumstances.",
    options: [
      {
        text: "Hire an exorcist and a psychic to cleanse the set.",
        effectDescription:
          "Costs $50k. The crew comes back, but you lose 5 reputation for looking ridiculous.",
        cashPenalty: 50000,
        reputationPenalty: 5,
      },
      {
  ...
  },
  {
    id: "crisis_51",
    description:
      "A major corporate sponsor realized their product is being used by the villain and is demanding extensive reshoots to make their soda look 'heroic'.",
    options: [
      {
        text: "Comply and write a scene where the hero drinks the soda.",
        effectDescription:
          "Costs $300k and delays the film by 1 week. The scene is cringe-inducing. Lose 15 buzz.",
        cashPenalty: 300000,
        weeksDelay: 1,
        buzzPenalty: 15,
      },
  ...
  },
  {
    id: "crisis_52",
    description:
      "During a massive crowd scene, a legitimate brawl breaks out among the extras, leading to several injuries and a police shutdown.",
    options: [
      {
  ...
  },
  {
    id: "crisis_53",
    description:
      "A critical prop—an authentic 17th-century guitar on loan from a museum—was accidentally smashed to splinters by the lead actor in a fit of rage.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $100k, but if caught, it'll be a disaster. The anxiety costs you 10 buzz.",
        cashPenalty: 100000,
        buzzPenalty: 10,
      },
      {
        ...
        effectDescription:
          "Saves the studio's face, but destroys crew morale. Delays production by 2 weeks and costs 5 reputation.",
        weeksDelay: 2,
        reputationPenalty: 5,
      },
    ],
  },
  {
    id: "crisis_54",
    description:
      "A rogue drone operator captured the entire climactic ending of the film and uploaded it to a popular subreddit, ruining the twist for millions.",
    options: [
      {
  ...
  },
  {
    id: "crisis_55",
    description:
      "The cultural consultant you hired just published a scathing 5,000-word exposé in a major magazine calling the film 'profoundly tone-deaf and insulting.'",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $500k. It's ugly, but it saves the film's buzz at the cost of 10 reputation.",
        cashPenalty: 500000,
        reputationPenalty: 10,
      },
      {
  ...
  },
  {
    id: "crisis_56",
    description:
      "The local mayor has revoked your filming permits after the director went on a profanity-laced tirade about the town's catering options.",
    options: [
      {
  ...
  },
  {
    id: "crisis_57",
    description:
      "Your lead talent has joined a 'wellness cult' in the desert and refuses to read any script pages that contain negative energy.",
    options: [
      {
  ...
  },
  {
    id: "crisis_58",
    description:
      "The studio executives have suddenly decided the film needs a talking CGI animal sidekick to boost merchandise sales, and they want it added retroactively to every scene.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "The executives back down, but your relationship is damaged. Lose 15 reputation.",
        reputationPenalty: 15,
      },
      {
        text: "Add the CGI animal, but make it deeply unsettling on purpose.",
        effectDescription:
          "Costs $500k. The internet turns it into a meme, but it alienates general audiences. Lose 20 buzz.",
        cashPenalty: 500000,
        buzzPenalty: 20,
      },
    ],
  },
  {
    id: "crisis_59",
    description:
      "The film's lead has decided they are a sovereign citizen and refuses to pay taxes or recognize the authority of the director, driving a golf cart through a live shot.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $2M to recast and reshoot. Major PR disaster. Lose 20 reputation.",
        cashPenalty: 2000000,
        reputationPenalty: 20,
      },
    ],
  },
  {
    id: "crisis_60",
    description:
      "A famous 'cancel culture' podcaster has targeted your movie because the villain drinks almond milk, which they claim is a dog whistle.",
    options: [
      {
  ...
  },
  {
    id: "crisis_61",
    description:
      "The 'intimacy coordinator' hired for the rom-com is actually the lead actor's ex-spouse, and they are using the job to enact petty revenge.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "The rom-com is dead. The documentary wins a minor festival. Lose 40 buzz.",
        buzzPenalty: 40,
      },
    ],
  },
  {
    id: "crisis_62",
    description:
      "A method actor playing a hacker has actually hacked the studio's payroll system and redistributed the executives' bonuses to the PAs.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "The executives despise you. Lose 25 reputation, but the crew loves you.",
  ...
  },
  {
    id: "crisis_63",
    description:
      "The studio's AI script-punch-up tool hallucinated a terrifying, 15-minute monologue about the end of the universe, and the director secretly filmed it.",
    options: [
      {
  ...
  },
  {
    id: "crisis_64",
    description:
      "Your sci-fi epic's lead actor refuses to come out of their trailer until the studio acknowledges that the earth is flat.",
    options: [
      {
  ...
  },
  {
    id: "crisis_65",
    description:
      "The movie's tie-in fast food toy has a massive design flaw: it looks exactly like an adult novelty item.",
    options: [
      {
  ...
  },
  {
    id: "crisis_66",
    description:
      "During a location shoot in a small town, the crew accidentally drank the local mayor's prize-winning artisanal kombucha stash.",
    options: [
      {
  ...
  },
  {
    id: "crisis_67",
    description:
      "The lead actress insists on bringing her 'emotional support python' on set, which has now escaped into the lighting grids.",
    options: [
      {
  ...
  },
  {
    id: "crisis_68",
    description:
      "A TikTok influencer snuck onto the set, filmed the movie's biggest twist, and is threatening to post it unless you give them a cameo.",
    options: [
      {
  ...
  },
  {
    id: "crisis_69",
    description:
      "The director spent $4M of the budget building a historically accurate 18th-century warship, only to realize the script is set in a landlocked desert.",
    options: [
      {
  ...
  },
  {
    id: "crisis_70",
    description:
      "The 'child prodigy' actor you hired has hit a massive growth spurt mid-shoot and is now taller than the adult male lead.",
    options: [
      {
  ...
  },
  {
    id: "crisis_71",
    description:
      "Your prestige historical drama has a scene where the protagonist uses a smartphone. Nobody noticed until the trailer dropped.",
    options: [
      {
  ...
  },
  {
    id: "crisis_72",
    description:
      "The catering company served undercooked chicken, and 80% of the crew is now bedridden with severe food poisoning.",
    options: [
      {
  ...
  },
  {
    id: "crisis_73",
    description:
      "An eccentric billionaire bought the rights to the IP you're adapting and is demanding you insert their NFT collection into the background of every scene.",
    options: [
      {
  ...
  },
  {
    id: "crisis_74",
    description:
      "Your prestige 'elevated horror' director has secretly replaced the original commissioned orchestral score with a terrifying, royalty-free AI synth track, claiming it 'speaks to the algorithm'.",
    options: [
      {
        text: "Force the composer's original score back into the edit.",
        effectDescription:
          "Costs $500k in union arbitration and mixing fees. The director throws a fit in the trades. Lose 20 buzz.",
        cashPenalty: 500000,
        buzzPenalty: 20,
      },
      {
        ...
        effectDescription:
          "The composer's guild sues you. Costs $1.5M in legal settlements and lose 15 reputation.",
        cashPenalty: 1500000,
        reputationPenalty: 15,
      },
      {
        ...
        effectDescription:
          "Costs $2M and adds 4 weeks of delay. It completely changes the movie's tone.",
        cashPenalty: 2000000,
        weeksDelay: 4,
      },
    ],
  },
  {
    id: "crisis_75",
    description:
      "The eccentric tech billionaire who heavily financed your sci-fi epic is demanding that the climax be entirely reworked to serve as a 10-minute commercial for their new 'Mars Colonization' crypto token.",
    options: [
      {
        text: "Refuse. Integrity over everything.",
        effectDescription:
          "The billionaire pulls their remaining funding. You must cover a massive $4M shortfall.",
        cashPenalty: 4000000,
      },
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $100k in rush VFX. The internet notices and mocks it, costing 15 buzz.",
        cashPenalty: 100000,
        buzzPenalty: 15,
      },
    ],
  },
  {
    id: "crisis_76",
    description:
      "Your lead actor's extremely litigious 'Lifestyle Brand' has slapped the production with a cease-and-desist because the prop department used an unauthorized, off-brand yoga mat in a crucial scene.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $1.2M in extensive rotoscoping and delays post-production by 3 weeks.",
        cashPenalty: 1200000,
        weeksDelay: 3,
      },
      {
        ...
        effectDescription:
          "The actor retaliates by trashing the set. Costs $300k in damages. Lose 10 reputation.",
        cashPenalty: 300000,
        reputationPenalty: 10,
      },
    ],
  },
  {
    id: "crisis_77",
    description:
      "A major international market has completely banned your film because a background extra is wearing a t-shirt that technically features an illegal political slogan.",
    options: [
      {
        text: "Create a localized, heavily-censored cut.",
        effectDescription:
          "Costs $2M in re-editing, VFX, and new dubbing. Delays the international release.",
        cashPenalty: 2000000,
      },
      {
        text: "Refuse to alter the art and lose the market entirely.",
        effectDescription:
          "Massive hit to the film's financial viability. Buzz takes a hit. Lose 35 buzz.",
        buzzPenalty: 35,
      },
      {
  ...
  },
  {
    id: "crisis_78",
    description:
      "The studio's highly anticipated 'Cinematic Universe' crossover movie just lost its main writer to a rival streaming service, taking the entire 'Series Bible' with them on a thumb drive.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $600k. The resulting lore is a mess. Lose 40 buzz from diehard fans.",
        cashPenalty: 600000,
        buzzPenalty: 40,
      },
      {
  ...
  },
  {
    id: "crisis_79",
    description:
      "During a high-speed chase scene, the stunt driver accidentally ramped a sports car through the front window of a beloved, historic local bakery.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $3M. You now own a bakery. The locals hate you. Lose 20 reputation.",
        cashPenalty: 3000000,
        reputationPenalty: 20,
      },
      {
  ...
  },
  {
    id: "crisis_80",
    description:
      "Your A-list director has locked themselves in the editing bay, claiming they have discovered the 'brown note' through audio frequency manipulation and intend to leave it in the final mix.",
    options: [
      {
        text: "Have security breach the door and confiscate the hard drives.",
        effectDescription:
          "Costs $200k in damages and severance. The director sues you. Lose 25 buzz.",
        cashPenalty: 200000,
        buzzPenalty: 25,
      },
      {
        ...
        effectDescription:
          "Test audiences literally soil themselves. Massive lawsuits ensue. Costs $3M.",
        cashPenalty: 3000000,
      },
      {
        text: "Secretly hire a secondary audio team to mix out the frequency at night.",
        effectDescription:
          "Costs $400k in overtime. The director never notices, but you're delayed 2 weeks.",
        cashPenalty: 400000,
        weeksDelay: 2,
      },
    ],
  },
  {
    id: "crisis_81",
    description:
      "A prominent 'anti-woke' YouTube grifter has launched a coordinated harassment campaign against your lead actress because her character knows how to fix a car engine.",
    options: [
      {
        text: "Release a strong public statement defending her and doubling down.",
        effectDescription:
          "The grifters review-bomb the project online. Lose 30 buzz, but gain 10 reputation with the industry.",
        buzzPenalty: 30,
        reputationPenalty: -10,
      },
      {
        ...
        effectDescription:
          "Costs $300k. The core fanbase realizes what you did and revolts. Lose 50 buzz and 25 reputation.",
        cashPenalty: 300000,
        buzzPenalty: 50,
        reputationPenalty: 25,
      },
      {
        ...
        effectDescription:
          "Costs $150k. It backfires spectacularly when traced back to the studio. Lose 20 reputation.",
        cashPenalty: 150000,
        reputationPenalty: 20,
      },
    ],
  },
  {
    id: "crisis_82",
    description:
      "The primary filming location—an abandoned hospital—was just condemned by the city halfway through production due to extreme asbestos exposure.",
    options: [
      {
        text: "Pay for full hazmat suits for the entire crew and keep shooting.",
        effectDescription:
          "Costs $800k in hazard pay and protective gear. The unions are furious. Lose 15 reputation.",
        cashPenalty: 800000,
        reputationPenalty: 15,
      },
      {
  ...
  },
  {
    id: "crisis_83",
    description:
      "Your 'focus-group-tested' comedy film has a joke about an obscure fruit that, as of yesterday, is the center of a massive global E. coli outbreak.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "The film's runtime is severely impacted and pacing is ruined. Delays post-production by 2 weeks.",
        weeksDelay: 2,
      },
    ],
  },
  {
    id: "crisis_84",
    description:
      "A rogue AI bot designed to drum up social media hype has become sentient and is relentlessly roasting the director's previous box office failures on the official movie account.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "The director threatens to quit. You spend $500k to placate them. Buzz increases slightly.",
        cashPenalty: 500000,
      },
      {
  ...
  },
  {
    id: "crisis_85",
    description:
      "Your romantic lead has developed a bizarre allergic reaction to the bespoke, $50,000 silk wardrobe and looks like a swollen tomato in every wide shot.",
    options: [
      {
  ...
  },
  {
    id: "crisis_86",
    description:
      "The film's 80-year-old legendary composer simply 'forgot' to write the score, cashing the check and submitting an empty hard drive on the final day of post-production.",
    options: [
      {
        text: "Hire a desperate, cheap up-and-comer to ghostwrite a score overnight.",
        effectDescription:
          "Costs $400k. The score sounds like a generic royalty-free track. Lose 30 buzz.",
        cashPenalty: 400000,
        buzzPenalty: 30,
      },
      {
        ...
        effectDescription:
          "Costs $1M in legal fees. The entire industry turns against you for suing an icon. Lose 35 reputation.",
        cashPenalty: 1000000,
  ...
  },
  {
    id: "crisis_87",
    description:
      "A sudden union strike by the catering department has brought the entire production to a screeching halt, with the crew demanding artisanal, locally-sourced craft services.",
    options: [
      {
      ...
      },
      {
        ...
        effectDescription:
          "Costs $250k. The crew is furious, and the Teamsters threaten to walk. Lose 20 reputation.",
        cashPenalty: 250000,
        reputationPenalty: 20,
      },
      {
  ...
  },
  {
    id: "crisis_88",
    description:
      "The wildly expensive 'Volume' LED stage you rented crashed, and due to a server error, the backdrop for your sci-fi planet is permanently stuck on a Windows 95 screensaver.",
    options: [
      {
