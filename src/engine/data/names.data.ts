export const PREFIXES = [
  ...
  'Generative', 'Post-Modern', 'Tax-Shelter', 'Franchised', 'Rebooted', 'Marketable',
  ...
  'Tax-Shelter', 'Algorithm-Driven', 'Shareholder-Approved', 'Prestige-Bait', 'IP-Farm', 'Metrics-Obsessed', 'Demographic-Targeted', 'Focus-Group-Tested', 'Corporate-Synergy', 'Subprime', 'Venture-Capital', 'Offshore-Account', 'Data-Mined', 'A/B-Tested', 'Post-Cancellable', 'Brand-Safe', 'Risk-Adjusted', 'Asset-Backed', 'Over-Leveraged', 'Nepotism-Fueled', 'Ghost-Directed', 'Generative-AI', 'Derivative', 'Plagiarized', 'Market-Corrected',
  'Vanguard',
  'Paradigm',
  'Synergistic',
  'Optimal',
...
export const SUFFIXES = [
  ...
  'Media Solutions', 'Data Mine', 'Rights Management',
  ...
  'Monopolies', 'Tax Havens', 'Content Farms', 'Shell Corporations', 'Synergies', 'Deliverables', 'Holding Companies', 'Analytics', 'Focus Groups', 'Market Research', 'IP Vaults', 'Franchise Portfolios', 'Merchandising Wings', 'Rights Management', 'Engagement Hubs', 'Hedge Funds', 'Trusts', 'Data Centers', 'Creative Silos', 'Content Pipelines', 'Conglomerates', 'Subsidiaries', 'Web3 Ventures', 'Metaverse Properties', 'Deepfakes',
  'Cartel',
  'Syndicate',
  'Conglomerate',
  'Monopoly',
...
export const MOTTOS = [
  ...
  'We don\'t make art, we make deliverables.', 'Quantity has a quality all its own.', 'Good enough for a second screen.', 'Trust the algorithm, not the auteur.', 'We fix it in post, always.', 'Focus grouped into submission.', 'Replacing writers with AI since last week.', 'We only greenlight what the data tells us to.', 'Artificially inflating our Rotten Tomatoes score.', 'Our accounting is more creative than our films.', 'Write it off, ship it out.', 'Monetizing your nostalgia, one reboot at a time.', 'It\'s not a movie, it\'s a four-week brand activation.', 'Catering to the lowest common denominator.', 'We buy your dreams and sell them back to you at a premium.', 'Because original ideas are too risky.', 'Lowering expectations, maximizing returns.', 'Our trailers are always better than the movie.', 'We don\'t make cinema, we make \'content\'.', 'Franchising your childhood memories.', 'A wholly-owned subsidiary of a private equity firm.', 'Demographics over storytelling.', 'We pivot to whatever the kids are doing on TikTok.', 'Where indie directors go to sell out.', 'We turn Twitter threads into cinematic universes.', 'The studio that killed the mid-budget drama.', 'We only do legacy sequels.', 'Putting the \'art\' in \'artificial intelligence\'.', 'Test audiences loved it, critics will hate it.', 'Where the algorithm writes the script.', 'Content to fold laundry to.',
  'Art through analytics.', 'Maximizing shareholder value since Q3.', 'Democratizing the algorithm.', 'Synergizing paradigms for a new era.', 'Where IP meets ROI.', 'Focus-grouped for your pleasure.', 'We know what you want before you do.', 'Leveraging assets, expanding universes.', 'Because art is just a tax write-off.', 'If it worked once, we will do it again.', 'Optimizing the human experience.', 'Your attention is our currency.', 'Building worlds, harvesting data.', 'It is not a movie, it is a content event.', 'Safe, sanitized, and synergistic.', 'Pioneering the generative content frontier.', 'We bought the rights, so you have to watch.', 'Monetizing nostalgia one reboot at a time.', 'You will subscribe, eventually.',
  ...
  'Art is just a byproduct of commerce.', 'We own your childhood memories.', 'Replacing creativity with algorithms since 2024.', 'Focus grouped to perfection.', 'Don\'t read the reviews, look at the engagement metrics.', 'Where art meets quarterly earnings.', 'We make the memes, you do the marketing.', 'Quantity has a quality all its own.', 'Your subscription is non-refundable.', 'If it bleeds, it streams.', 'We pivot to whatever is trending.', 'Catering exclusively to the lowest common denominator.', 'We fix it in post.', 'A tax write-off in the making.', 'Please don\'t unionize.', 'We bought the rights, you buy the ticket.', 'Content you can scroll past.', 'Our trailers are better than our movies.', 'A subsidiary of a subsidiary.', 'Monetizing your nostalgia.', 'Because original ideas are too expensive.', 'Demographically optimized for maximum retention.', 'We don\'t make movies, we make content.', 'Sacrificing art for shareholder value.', 'We own the rights to your dreams.',
...
export const DICTIONARIES: Record<string, { nouns: string[], adjs: string[] }> = {
  ...
  'Sci-Fi': {
    ...
    adjs: ['Galactic', 'Cosmic', 'Quantum', 'Cyber', 'Neon', 'Infinite', 'Parallel', 'Unknown', 'Alien', 'Virtual', 'Solar', 'Lunar', 'Stellar', 'Digital', 'Synthetic', 'Procedural', 'Algorithmic', 'Generative', 'Simulated', 'Crypto', 'Retro-Futuristic', 'Post-Apocalyptic', 'Dystopian', 'Utopian', 'Interstellar', 'Multiversal', 'Transdimensional', 'Chronological', 'AI-Generated', 'Tokenized', 'Decentralized', 'Plagiarized', 'Machine-Learned', 'Automated', 'Holographic']
  },
  'Thriller': {
