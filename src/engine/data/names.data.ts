...
export const MOTTOS: string[] = [
  ...
  "Franchises are forever",
  "Your nostalgia, our profit",
  "Selling the dream",
  "Pivoting to video",
  "The universe is expanding",
  "Building the metaverse",
  "Vertical integration realized",
  "From script to stream",
  "Disrupting the narrative",
  "Content for the modern attention span",
  "Art as a service",
  "Monetizing the zeitgeist",
  "We own your childhood",
  "A cinematic universe of our own",
  "Quantity over quality",
  "Fast and cheap",
  "Good enough for streaming",
  "We fix it in post",
  "Trust the algorithm",
  "Four quadrants or bust",
  "IP is king",
  "Franchises forever",
  ...
  "We only make sequels",
  "Original ideas are risky",
  "Focus grouped to perfection",
  "Bland but profitable",
  "Safely generic",
  "Write it off for taxes",
  "Don't read the reviews",
  "Our trailers are better than the movie",
  "Cancel culture is our best marketing",
  "Replacing actors with AI since 2024",
  "Please subscribe to our streaming tier",
  "We own the rights to your dreams",
  "Greenlighting based on TikTok trends",
  "If it bleeds, we stream it",
  "Milking the IP dry",
  "Another reboot no one asked for",
  "Lowering the bar daily",
  "We'll fix it in the edit.",
  "Generated by our proprietary LLM.",
  "More content than you could ever watch.",
  "Tax evasion is an art form.",
  "Art is just a byproduct of commerce.",
  "A subsidiary of a hedge fund.",
  ...
  "Because art is whatever the spreadsheet says it is.",
  "We make movies so you can look at your phone.",
  "Your attention is our quarterly bonus.",
  "Minimizing risk, maximizing mediocrity.",
  "We greenlight what you already know.",
  "Recycling your childhood for our shareholders.",
  "If it makes money, it's cinema.",
  "We don't make films, we make four-quadrant content events.",
  "Tax evasion disguised as entertainment.",
  "Algorithmic perfection, artistic bankruptcy.",
  "Our focus groups are never wrong.",
  "Selling you the same story, repackaged.",
  "Art is just a vehicle for merchandising.",
  "Because original ideas don't test well.",
  "We fixed the script in the marketing department.",
  "We don't care if it's good, as long as it trends.",
  "Where creativity goes to get focus-grouped.",
  "Your nostalgia is our greatest asset.",
  "Art is just a byproduct of commerce.",
