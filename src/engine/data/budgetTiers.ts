...
export const BUDGET_TIERS: Record<BudgetTierKey, BudgetTierData> = {
  indie: {
    ...
    developmentWeeks: 4,
    productionWeeks: 4,
    // The Studio Comptroller: Increased upside for indie hits to 30M while lowering floor to 1k for complete flops.
    revenueRange: [1_000, 30_000_000],
  },
  low: {
    key: 'low',
    name: 'Low Budget',
  ...
  mid: {
    ...
    developmentWeeks: 8,
    productionWeeks: 12,
    // The Studio Comptroller: Pushed mid-tier ceiling to 900M to allow for breakout comedy/action hits, lowered floor to 50k.
    revenueRange: [50_000, 900_000_000],
  },
  high: {
    key: 'high',
    name: 'High Budget',
    label: '$80M',
    budget: 80_000_000,
    weeklyCost: 4_000_000,
    developmentWeeks: 12,
    productionWeeks: 16,
    // The Studio Comptroller: Increased high budget ceiling to 2.5B to simulate modern IP expansions and lowered floor to 500k.
