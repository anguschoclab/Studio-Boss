export const WORLD_EVENT_POOL = [
  ...
  'Virtual Reality pioneer announces a "cinema killer" platform.',
  "Major studio lot fire disrupts production schedules city-wide.",
  "A surprise merger between two A-list talent agencies sends shockwaves.",
  "New AI content laws passed after a month of protests.",
];
