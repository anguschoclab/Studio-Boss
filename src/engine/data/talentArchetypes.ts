...
export const ACTOR_ARCHETYPES: Record<ActorArchetype, ArchetypeConfig> = {
  movie_star: {
    ...
    name: "Movie Star",
    description:
      "Big-screen actors who prefer films over TV, command high fees, and have strong brand recognition.",
  ...
  character_actor: {
    ...
    description:
      "Versatile actors known for playing diverse roles, often in supporting but memorable parts.",
  ...
  prestige_actor: {
    ...
    name: "Prestige Actor",
    description:
      "Critically acclaimed actors who prioritize artistic projects over commercial success.",
    tierBias: ["A_LIST", "B_LIST"],
    projectPreferences: {
      formats: ["film"],
  ...
  indie_darling: {
    ...
    name: "Indie Darling",
    description:
      "Actors who made their name in independent films, often seeking artistic fulfillment.",
    tierBias: ["B_LIST", "C_LIST", "NEWCOMER"],
    projectPreferences: {
      formats: ["film"],
  ...
  viral_sensation: {
    ...
    description:
      "Actors who gained fame through social media or viral content, often with limited traditional training.",
  ...
  kid_actor: {
    ...
    name: "Kid Actor",
    description:
      "Child actors who typically start in family-friendly content and must navigate career transitions as they age.",
    tierBias: ["C_LIST", "NEWCOMER"],
    projectPreferences: {
      formats: ["tv", "film"],
      budgetTiers: ["low", "mid", "high"],
  ...
  young_adult: {
    ...
    name: "Young Adult",
    description:
      "Actors in their late teens to early twenties transitioning from child roles to adult content.",
    tierBias: ["B_LIST", "C_LIST"],
    projectPreferences: {
  ...
  veteran: {
    ...
    name: "Veteran",
    description:
      "Established actors with decades of experience, often taking mentorship roles or character parts.",
    tierBias: ["A_LIST", "B_LIST"],
    projectPreferences: {
 ...
 */
export function generateArchetypeForRole(
  role: string,
  tier: TalentTier,
  rng: { next: () => number }
): string {
