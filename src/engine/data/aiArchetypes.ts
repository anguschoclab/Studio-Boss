...
export const STUDIO_ARCHETYPES: Record<string, StudioArchetype> = {
  BLOCKBUSTER_BULL: {
    ...
    budget_tier_weights: { indie: 0.0, low: 0.05, mid: 0.2, high: 0.4, blockbuster: 0.35 },
    pact_aggression: 0.3,
    ma_willingness: 0.6,
  ...
  PRESTIGE_PURIST: {
    ...
    greenlight_bias: ["film"],
    budget_tier_weights: { indie: 0.1, low: 0.2, mid: 0.45, high: 0.2, blockbuster: 0.05 },
    pact_aggression: 0.4,
    ma_willingness: 0.2,
  ...
  GENRE_KING: {
    ...
    greenlight_bias: ["film"],
    budget_tier_weights: { indie: 0.1, low: 0.3, mid: 0.4, high: 0.15, blockbuster: 0.05 },
    pact_aggression: 0.2,
    ma_willingness: 0.2,
  ...
  SILENT_POACHER: {
    ...
    genreFocus: ["Any"],
    greenlight_bias: ["film", "tv"],
    budget_tier_weights: { indie: 0.1, low: 0.15, mid: 0.5, high: 0.2, blockbuster: 0.05 },
    pact_aggression: 0.6,
    ma_willingness: 0.3,
  ...
  BALANCED_GIANT: {
    ...
    genreFocus: ["Any"],
    greenlight_bias: ["film", "tv"],
    budget_tier_weights: { indie: 0.0, low: 0.1, mid: 0.25, high: 0.4, blockbuster: 0.25 },
    pact_aggression: 0.3,
    ma_willingness: 0.5,
  ...
  CASH_COW: {
    ...
    greenlight_bias: ["film", "tv"],
    budget_tier_weights: { indie: 0.1, low: 0.6, mid: 0.25, high: 0.05, blockbuster: 0.0 },
  ...
  RETRO_REVOLUTIONARY: {
    ...
    greenlight_bias: ["film", "tv"],
    budget_tier_weights: { indie: 0.0, low: 0.1, mid: 0.3, high: 0.4, blockbuster: 0.2 },
    pact_aggression: 0.4,
    ma_willingness: 0.5,
    festivalParticipation: 0.4,
