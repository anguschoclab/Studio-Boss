...
export const AGENCY_ARCHETYPES: Record<AgencyArchetype, AgencyArchetypeData> = {
  ...
  nepotism_mill: {
    key: 'nepotism_mill',
    name: 'Nepotism Mill',
    description: 'Identity: The Nepotism Mill — Specialized in placing entirely unqualified offspring of Hollywood royalty into leading roles. They demand massive ego-stroking, completely unearned top billing, and aggressively suppress any reviews that point out their clients\'s lack of talent.',
    leverage_base: 30,
    pact_aggression: 0.20,
