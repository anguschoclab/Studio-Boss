...
export interface AgencyArchetypeData {
  ...
  name: string;
  description: string;
  // Behavioral properties for archetype-driven behavior
  pact_aggression: number;      // 0-1: probability of poaching in any given week
  leverage_base: number;         // 0-100: base negotiation leverage
  negotiation_tactic_preferences: string[]; // Preferred negotiation tactics
  festivalParticipation: number; // 0-1: weight for festival submissions
  genreFocus: string[];         // Preferred genres for talent representation
}
...
export const AGENCY_ARCHETYPES: Record<AgencyArchetype, AgencyArchetypeData> = {
  powerhouse: {
    ...
    pact_aggression: 0.6,
    leverage_base: 90,
    negotiation_tactic_preferences: ['PACKAGE_DEAL', 'EXCLUSIVE_COMMITMENT', 'TRILOGY_MANDATE'],
    festivalParticipation: 0.3,
    genreFocus: ['Drama', 'Action', 'Sci-Fi', 'Fantasy']
  },
  boutique: {
    ...
    pact_aggression: 0.3,
    leverage_base: 70,
    negotiation_tactic_preferences: ['FINAL_CUT', 'CREATIVE_CONTROL', 'ANALOG_SHOOT'],
    festivalParticipation: 0.9,
    genreFocus: ['Drama', 'Art House', 'Horror', 'Romance']
  },
  shark: {
    ...
    pact_aggression: 0.9,
    leverage_base: 95,
    negotiation_tactic_preferences: ['BACKEND_POINTS', 'POACHING', 'MEDIA_THREATS'],
    festivalParticipation: 0.2,
    genreFocus: ['Any']
  },
  comedy_specialist: {
    ...
    pact_aggression: 0.4,
    leverage_base: 60,
    negotiation_tactic_preferences: ['SCRIPT_PUNCH_UP', 'STANDUP_OPENER', 'STREAMING_BACKEND'],
    festivalParticipation: 0.4,
    genreFocus: ['Comedy', 'Romance', 'Animation']
  },
  lit_agency: {
    ...
    pact_aggression: 0.3,
    leverage_base: 75,
    negotiation_tactic_preferences: ['PACKAGE_DEAL', 'CREDIT_ARBITRATION', 'SCRIPT_CONTROL'],
    festivalParticipation: 0.7,
    genreFocus: ['Drama', 'Thriller', 'Historical']
  },
  mega_corp: {
    ...
    pact_aggression: 0.5,
    leverage_base: 85,
    negotiation_tactic_preferences: ['CROSSOVER_CAMEO', 'BRAND_INTEGRATION', 'AWARD_CAMPAIGN'],
    festivalParticipation: 0.5,
    genreFocus: ['Action', 'Sci-Fi', 'Fantasy', 'Family']
  },
  streaming_titan: {
    ...
    pact_aggression: 0.5,
    leverage_base: 80,
    negotiation_tactic_preferences: ['UPFRONT_PAYMENT', 'ALGORITHMIC_BACKEND', 'SKIP_THEATRICAL'],
    festivalParticipation: 0.4,
    genreFocus: ['Sci-Fi', 'Fantasy', 'Crime', 'Thriller']
  },
  indie_darling: {
    ...
    pact_aggression: 0.2,
    leverage_base: 65,
    negotiation_tactic_preferences: ['ANALOG_SHOOT', 'AUTEUR_DIRECTOR', 'EXTENDED_REHEARSAL'],
    festivalParticipation: 0.95,
    genreFocus: ['Art House', 'Documentary', 'Animation', 'Drama']
  },
  nepotism_mill: {
    ...
    pact_aggression: 0.1,
    leverage_base: 50,
    negotiation_tactic_preferences: ['EGO_STROKING', 'TOP_BILLING', 'REVIEW_SUPPRESSION'],
    festivalParticipation: 0.1,
    genreFocus: ['Comedy', 'Romance', 'Family']
  },
  international_broker: {
    ...
    pact_aggression: 0.4,
    leverage_base: 70,
    negotiation_tactic_preferences: ['CROSS_CULTURAL', 'INTERNATIONAL_TOUR', 'FOREIGN_BACKEND'],
    festivalParticipation: 0.5,
    genreFocus: ['Action', 'Drama', 'Thriller']
  },
  legacy_defenders: {
    ...
    pact_aggression: 0.2,
    leverage_base: 60,
    negotiation_tactic_preferences: ['LEGACY_SALARY', 'ONSET_PERKS', 'THEATRICAL_RELEASE'],
    festivalParticipation: 0.3,
    genreFocus: ['Drama', 'Action', 'Historical']
  },
  genre_kings: {
    ...
    pact_aggression: 0.3,
    leverage_base: 75,
    negotiation_tactic_preferences: ['SCRIPT_PUNCH_UP', 'INTERNATIONAL_BACKEND', 'GENRE_RESTRICTION'],
    festivalParticipation: 0.4,
    genreFocus: ['Horror', 'Sci-Fi', 'Action', 'Thriller']
  },
  talent_agency_arm: {
    ...
    pact_aggression: 0.6,
    leverage_base: 80,
    negotiation_tactic_preferences: ['CROSS_PROMOTION', 'ROSTER_SYNERGY', 'STUDIO_OPS'],
    festivalParticipation: 0.4,
    genreFocus: ['Drama', 'Comedy', 'Thriller']
  },
  influencer_syndicate: {
    ...
    pact_aggression: 0.4,
    leverage_base: 55,
    negotiation_tactic_preferences: ['SOCIAL_MEDIA', 'INFLUencer_CASTING', 'VIRAL_CONTENT'],
    festivalParticipation: 0.1,
    genreFocus: ['Comedy', 'Romance', 'Family', 'Reality']
  }
};
