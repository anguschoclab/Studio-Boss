...
const PROJECT_ADJECTIVES = [
  "Extortionate",
  "PR-Cursed",
  "Algorithmically-Mandated",
  "Sovereign-Citizen-Funded",
  "Cryptocurrency-Evading",
  "TikTok-Ruined",
  "VFX-Destitute",
  "Focus-Group-Mutilated",
  "De-Aged",
  "Self-Funded",
...
const PROJECT_NOUNS = [
  ...
  "Crypto-Scam Spinoff",
  "Audience Test Disaster",
  "Tax Write-off",
  "Apology Video Extended Cut",
  "Podcast Spin-off",
  "Focus Group Disaster",
  "Legacy Sequel",
  "Cinematic Universe Attempt",
  "Vanity Project",
  "Merchandise Commercial",
  "Brand Synergy Play",
  "Legal Loophole",
  "NFT Cash Grab",
  "Direct-to-Streaming Dump",
  "TikTok Trend Movie",
  "Algorithm Bait",
  "Studio Mandate",
  ...
  "Bailout",
  "Bankruptcy Filing",
  "Streaming-Service Tax Dodge",
  "Hush-Money Payout",
  "Damage-Control Press Tour",
  "Crypto Collapse Story",
  "CGI Monster Flop",
  "Subreddit Conspiracy",
  "Review-Bomb Casualty",
  "Focus Group Hallucination",
  "Algorithm-Generated Mess",
  "Merch Dump",
];

const CYNICAL_FLAVOR_GENERATORS: Array<
  (genre: string, type: string, budgetTier: BudgetTierKey, origin: string) => string
> = [
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  (genre, type, budgetTier, origin) =>
...
function generateFlavor(
  ...
  return pick(CYNICAL_FLAVOR_GENERATORS)(genre, type, budgetTier, origin);
}
...
export function generateOpportunity(_weekOrTalentIds?: number | string[]): Opportunity {
  ...
  const opt: Opportunity = {
    ...
    weeksUntilExpiry,
    attachedTalentIds:
      talentIds && talentIds.length > 0 && rand() > 0.5 ? [pick(talentIds)] : undefined,
    bids: {},
    bidHistory: [],
