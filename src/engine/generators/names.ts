...
const PREFIXES = [
  ...
  // Scribe Additions
  'Tax-Exempt', 'Algorithm-Approved', 'Deepfake', 'Focus-Tested', 'Sanitized', 'Corporate-Mandated', 'Nepo', 'Vulture', 'Hedge Fund', 'Private Equity', 'Data-Mined', 'A.I. Generated', 'Post-Credit', 'Focus-Grouped', 'Merch-Driven', 'Tax-Writeoff', 'Shell', 'Laundered', 'Overleveraged', 'Boutique', 'Uncancelled'
];
...
const SUFFIXES = [
  ...
  // Scribe Additions
  'Acquisitions', 'Assets', 'Portfolios', 'Capital', 'Trust', 'Conglomerate', 'Monopoly', 'Subsidiary', 'Media Empire', 'Omnicorp', 'Content Farm', 'Clickfarm', 'Metrics', 'Data Systems'
];
