...
export function isUnscriptedProject(
  project: Project
): project is UnscriptedProject & { type: "SERIES" } {
 ...
 */
export function calculateTalentFitScore(
  talent: Talent,
  project: Project,
  targetRole?: string,
 ...
 */
export function getRecommendedTalentForProject(
  talentPool: Talent[],
  project: Project,
  targetRole?: string,
  attachedTalentIds?: string[]
