...
export const tokens = {
  ...
  glass: {
    ...
    elevated:
      "bg-gradient-to-br from-card/90 to-card/50 backdrop-blur-2xl border border-white/20 shadow-2xl hover:shadow-[0_0_30px_hsl(var(--primary)/0.15)] transition-all duration-300",
  },
  ...
  interactive: {
    ...
    active:
      "bg-primary/15 text-primary border-primary/30 shadow-[0_0_15px_hsl(var(--primary)/0.15)]",
...
export const patterns = {
  ...
  button: {
    ...
    ghost: combineTokens("hover:bg-white/5", tokens.transition.fast),
  },

  sectionHeader: combineTokens("flex items-center gap-4", "mb-6", "pb-4 border-b border-white/5"),
};
