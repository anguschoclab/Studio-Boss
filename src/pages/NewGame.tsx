...
import { Dices, Shield, Zap, Target, ArrowRight } from 'lucide-react';
      ...
      <div className="w-full max-w-6xl space-y-20 animate-in fade-in slide-in-from-bottom-8 duration-1000 relative z-10">
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="flex items-center gap-4 px-2">
            ...
            <label htmlFor="studioName" className="text-[10px] font-black text-muted-foreground/40 uppercase tracking-[0.3em] italic">CORPORATE DESIGNATION</label>
          </div>
          <div className="flex gap-4">
            ...
            >
              <Dices className="h-8 w-8 group-hover:rotate-180 transition-transform duration-700" strokeWidth={1} />
            </Button>
          </div>
        ...
        <div className="space-y-10">
           <div className="flex items-center gap-4 px-2">
              ...
              <label className="text-[10px] font-black text-muted-foreground/40 uppercase tracking-[0.3em] italic">OPERATIONAL ARCHETYPE</label>
           </div>
        ...
        <div className="flex flex-col items-center gap-12 pt-10 pb-20">
          <div className="flex justify-center gap-8 w-full max-w-xl">
            ...
            >
              INITIALIZE_STUDIO <ArrowRight className="ml-4 h-4 w-4 group-hover:translate-x-2 transition-transform" strokeWidth={3} />
            </Button>
          </div>
