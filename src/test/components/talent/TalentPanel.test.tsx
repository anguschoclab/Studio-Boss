...
describe("TalentPanel", () => {
  ...
  it("filters talent by role", () => {
    ...
    // Filter by director
    const directorButton = screen
      .getAllByText((content, element) => element?.textContent?.toLowerCase() === "director")
  ...
  it("shows empty state when no talent matches filter", () => {
    ...
    const writerButton = screen
      .getAllByText((content, element) => element?.textContent?.toLowerCase() === "writer")
      .find((el) => el.tagName === "BUTTON");
