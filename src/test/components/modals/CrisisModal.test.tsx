...
describe("CrisisModal", () => {
  ...
  beforeEach(async () => {
    ...
    (useUIStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      activeModal: {
        type: "CRISIS",
        payload: { projectId: "proj-123", crisis: mockProject.activeCrisis },
      },
  ...
  it("renders nothing if crisisProjectId is missing", () => {
    (useUIStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      activeModal: {
        type: "CRISIS",
        payload: { projectId: null, crisis: mockProject.activeCrisis },
      },
      resolveCurrentModal: mockCloseCrisisModal,
    });
  ...
  it("renders nothing if project is not found", () => {
    (useUIStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      activeModal: {
        type: "CRISIS",
        payload: { projectId: "non-existent", crisis: mockProject.activeCrisis },
      },
      resolveCurrentModal: mockCloseCrisisModal,
    });
