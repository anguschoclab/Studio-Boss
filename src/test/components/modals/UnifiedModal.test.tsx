...
describe("UnifiedModal", () => {
  ...
  it("renders with subtitle", () => {
    render(
      <UnifiedModal isOpen={true} onClose={() => {}} title="Title" subtitle="This is the subtitle">
        <div>Content</div>
      </UnifiedModal>
    );
  ...
  it("renders with icon", () => {
    render(
      <UnifiedModal isOpen={true} onClose={() => {}} title="Settings" icon={Settings}>
        <div>Content</div>
      </UnifiedModal>
    );
  ...
  it("does not close when preventClose is true", () => {
    const handleClose = vi.fn();
    render(
      <UnifiedModal isOpen={true} onClose={handleClose} title="Test" preventClose>
        <div>Content</div>
      </UnifiedModal>
    );
  ...
  it("hides close button when showCloseButton is false", () => {
    render(
      <UnifiedModal isOpen={true} onClose={() => {}} title="Test" showCloseButton={false}>
        <div>Content</div>
      </UnifiedModal>
    );
  ...
  it("accepts custom className", () => {
    render(
      <UnifiedModal isOpen={true} onClose={() => {}} title="Test" className="custom-modal-class">
        <div>Content</div>
      </UnifiedModal>
    );
