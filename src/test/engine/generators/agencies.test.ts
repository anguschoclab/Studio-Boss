...
describe('Agency Generation', () => {
  it('generates the correct archetypes and prefixes', () => {
    ...
    expect(['comedy_specialist', 'mega_corp', 'boutique', 'indie_darling', 'streaming_titan', 'lit_agency', 'nepotism_mill', 'international_broker']).toContain(agencies[2].archetype);
