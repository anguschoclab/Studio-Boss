...
describe('Agency Generation', () => {
  it('generates the correct archetypes and prefixes', () => {
    ...
    expect(['comedy_specialist', 'mega_corp', 'boutique', 'indie_darling', 'streaming_titan', 'lit_agency', 'international_broker', 'nepotism_mill']).toContain(agencies[2].archetype);
