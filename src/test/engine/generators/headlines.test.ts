...
describe('generateHeadlines', () => {
  ...
  it('should generate rival headlines if rivals are provided', () => {
    const week = 10;
    const rivals: RivalStudio[] = [
      { id: 'rival-1', name: 'Global Pictures', cash: 100000000, projectCount: 5, motto: 'Bigger is Better', archetype: 'major', strength: 80, prestige: 80, recentActivity: 'Signing stars', motivationProfile: { financial: 0.8, prestige: 0.8, legacy: 0.5, aggression: 0.5 }, currentMotivation: 'prestige' as unknown as any, projects: {}, contracts: [], foundedWeek: 1 },
    { id: 'rival-2', name: 'Indie Art', cash: 1000000, projectCount: 2, motto: 'Art First', archetype: 'major', strength: 20, prestige: 60, recentActivity: 'Festivals', motivationProfile: { financial: 0.2, prestige: 0.9, legacy: 0.8, aggression: 0.3 }, currentMotivation: 'legacy' as unknown as any, projects: {}, contracts: [], foundedWeek: 1 }
    ];
  ...
  it('should interpolate talent headlines with project and director names', () => {
    ...
    const projects = [{ 
      ...
      title: 'Test Movie', 
      format: 'film',
      genre: 'action' as unknown as any,
      budgetTier: 'mid',
      budget: 1000000, 
      weeklyCost: 10000,
    ...
    const contracts = [{ 
      ...
      projectId: 'p1', 
      talentId: 't1', 
      role: 'director' as unknown as any,
      salary: 100000, 
      length: 1, 
      weekStarted: 1 
    }];
    ...
    for (let i = 0; i < 50; i++) {
      const headlines = generateHeadlines(1, rivals, projects as unknown as any, contracts as unknown as any, talent as unknown as any);
