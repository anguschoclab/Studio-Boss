      ...
      const mockSnapshots: NielsenSnapshot[] = [
        {
          week: 1,
          episodeNumber: 1,
          totalViewers: 10_000_000,
          liveSDViewers: 10_000_000,
          live7Viewers: 10_000_000,
          keyDemo: 2.0,
          timeSlot: "9PM",
          demoRatings: [],
          householdRating: 2.0,
        ...
        },
        {
          week: 2,
          episodeNumber: 2,
          totalViewers: 8_000_000,
          liveSDViewers: 8_000_000,
          live7Viewers: 8_000_000,
          keyDemo: 1.6,
          timeSlot: "9PM",
          demoRatings: [],
          householdRating: 1.6,
        ...
        },
        {
          week: 3,
          episodeNumber: 3,
          totalViewers: 9_000_000,
          liveSDViewers: 9_000_000,
          live7Viewers: 9_000_000,
          keyDemo: 1.8,
          timeSlot: "9PM",
          demoRatings: [],
          householdRating: 1.8,
  ...
  describe("rankShows", () => {
    it("ranks shows based on A18-49 demo rating", () => {
      ...
      map.set("show1", {
        ...
        trend: "STABLE",
        demoRatings: [
          { demo: "A18-49", label: "Adults 18-49", rating: 1.5, viewers: 50 },
          { demo: "P2+", label: "Total Viewers", rating: 2.0, viewers: 100 },
        ],
      });
      map.set("show2", {
        week: 1,
