...
describe("StreamingViewershipTracker", () => {
  describe("initializeViewership", () => {
    ...
    it("applies genre modifiers to completion rate correctly", () => {
      ...
      const dramaHistory = StreamingViewershipTracker.initializeViewership(
        dramaProject,
        "p1",
        platform,
        1,
      ...
      const comedyHistory = StreamingViewershipTracker.initializeViewership(
        comedyProject,
        "p1",
        platform,
        1,
      ...
      const neutralHistory = StreamingViewershipTracker.initializeViewership(
        neutralProject,
        "p1",
        platform,
        1,
  ...
  describe("updateViewership", () => {
    it("updates viewership correctly for binge release model", () => {
      ...
      // initial
      let history = StreamingViewershipTracker.initializeViewership(
        project,
        "platform-1",
        platform,
        10,
