...
describe('evaluateProjectCrises', () => {
  it('does nothing if a crisis is already active', () => {
    const project = { id: '1', activeCrisis: { crisisId: 'onset_altercation', triggeredWeek: 5, haltedProduction: true } } as Project;
  ...
  it('triggers a crisis if RNG hits the threshold', () => {
    const project = { id: '1', activeCrisis: null } as Project;
