...
describe("TalentAgentInteractionEngine", () => {
  ...
  describe("calculateCompatibility", () => {
    it("should return a compatibility score with all required fields", () => {
      const result = TalentAgentInteractionEngine.calculateCompatibility(
        "collaborative",
        "diplomat"
      );
    ...
    it("should have higher compatibility for matching personalities", () => {
      const collaborativeDiplomat = TalentAgentInteractionEngine.calculateCompatibility(
        "collaborative",
        "diplomat"
      );
      const collaborativeShark = TalentAgentInteractionEngine.calculateCompatibility(
        "collaborative",
        "shark"
      );
  ...
  describe("updateRelationship", () => {
    ...
    it("should boost relationship for high-value deals", () => {
      ...
      const normalDeal = TalentAgentInteractionEngine.updateRelationship(
        relationship,
        true,
        500000
      );
      const highValueDeal = TalentAgentInteractionEngine.updateRelationship(
        relationship,
        true,
        5000000
      );
  ...
  describe("calculateCompatibilityMatrix", () => {
    it("should calculate compatibility for all talent-agent pairs", () => {
      ...
      const matrix = TalentAgentInteractionEngine.calculateCompatibilityMatrix(
        talents,
        agents,
        agencies
      );
