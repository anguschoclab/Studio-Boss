...
function releasedProject(ownerId: string): Project {
  return {
    ...
    boxOffice: {
      openingWeekendDomestic: 50_000_000,
      openingWeekendForeign: 20_000_000,
      totalDomestic: 200_000_000,
      totalForeign: 100_000_000,
      multiplier: 3,
    },
    reviewScore: 75,
    rating: "PG-13",
...
describe("RivalRevenueCalculator — integration", () => {
  it("returns > 0 once a rival owns a released project", () => {
    ...
    const revenue = RivalRevenueCalculator.calculateWeeklyRevenue(
      ...
      { entities: { projects: { "proj-r1": releasedProject("r1") } } } as any
    );
