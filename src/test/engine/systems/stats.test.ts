...
describe('stats system', () => {
  describe('getFilmStats', () => {
    ...
    it('applies 1.5x risk multiplier for high tier (budget >= 100M)', () => {
    ...
    it('applies 2.5x risk multiplier for blockbuster tier (budget >= 250M)', () => {
  ...
  describe('getTvStats', () => {
    ...
    it('applies 1.5x scale multiplier for high tier (budget > 50M)', () => {
    ...
    it('applies 2.0x scale multiplier for blockbuster tier (budget >= 100M)', () => {
      const tier = BUDGET_TIERS.blockbuster;
      const stats = getTvStats(tier, format, episodes);
  ...
  describe('getUnscriptedStats', () => {
    ...
    it('applies 1.5x scale multiplier for high tier (budget > 50M) for weekly cost only', () => {
      const tier = BUDGET_TIERS.high;
      const stats = getUnscriptedStats(tier, format, episodes);
