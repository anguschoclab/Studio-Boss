 ...
 */
export interface GameStore extends ProjectSlice, FinanceSlice, TalentSlice, RivalSlice, NewsSlice, SnapshotSlice, LoanSlice, BookmarkSlice, DistressSlice, MarketingSlice {
