      ...
      <div className="bg-white/[0.02] border-b border-white/5 p-10 relative overflow-hidden">
        ...
        <div className="flex justify-between items-center relative z-10">
          ...
          <div className="flex items-center gap-10">
            ...
            {onClose && (
              <Button variant="ghost" size="icon" aria-label="Close Marketing War Room" tooltip="Close" onClick={onClose} className="h-12 w-12 hover:bg-white/5 border border-transparent hover:border-white/10 rounded-none">
