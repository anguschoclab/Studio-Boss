...
const variantStyles: Record<CardVariant, string> = {
  ...
  interactive:
    "bg-white/[0.01] border-white/5 hover:border-primary/40 hover:bg-white/[0.04] cursor-pointer shadow-2xl hover:shadow-[0_0_80px_rgba(0,0,0,0.8)]",
...
const iconColorStyles = {
  ...
  secondary:
    "bg-secondary/5 text-secondary border-secondary/20 shadow-[0_0_30px_rgba(var(--secondary),0.2)]",
  success:
    "bg-emerald-500/5 text-emerald-500 border-emerald-500/20 shadow-[0_0_30px_rgba(16,185,129,0.2)]",
  warning:
    "bg-amber-500/5 text-amber-500 border-amber-500/20 shadow-[0_0_30px_rgba(251,191,36,0.2)]",
  destructive:
    "bg-rose-500/5 text-rose-500 border-rose-500/20 shadow-[0_0_30px_rgba(244,63,94,0.2)]",
};
  ...
  return (
    <CardWrapper
      ...
      className={cn(
        ...
        isInteractive &&
          "w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2",
    ...
    >
      ...
      {/* Footer */}
      {footer && <div className="mt-12 pt-12 border-t border-white/5">{footer}</div>}
    </CardWrapper>
  );
};
...
export const StatRow: React.FC<{
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-between py-6 group border-b border-white/[0.05] last:border-0 hover:bg-white/[0.01] px-4 -mx-4 transition-all duration-700",
        className
      )}
    >
      ...
      <div className="flex items-center gap-8">
        ...
        {trend && (
          <span
            className={cn(
              "text-[10px] font-black uppercase italic tracking-[0.2em] px-3 py-1.5 rounded-none border shadow-2xl transition-all duration-700 group-hover:scale-110",
              trendColors[trend]
            )}
          >
