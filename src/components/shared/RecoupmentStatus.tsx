    ...
    <TooltipWrapper
      tooltip={
        <div className="space-y-4 p-2 min-w-[200px]">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] italic border-b border-white/5 pb-3 mb-1">
            RECOUPMENT AUDIT
          </p>
          <div className="space-y-2">
            <div className="flex justify-between text-[9px] gap-6">
              <span className="text-muted-foreground/40 uppercase font-black italic tracking-[0.2em]">
                INVESTMENT
              </span>
              <span className="font-display font-black text-foreground italic tracking-tighter">
            ...
            <div className="flex justify-between text-[9px] gap-6">
              ...
              <span className="font-display font-black text-emerald-400 italic tracking-tighter">
                {formatMoney(revenue)}
              </span>
            </div>
          </div>
    ...
    >
      <div className={cn("space-y-3", className)}>
        <div className="flex justify-between items-center text-[9px] font-black uppercase tracking-[0.3em] italic leading-none">
          ...
          <span
            className={cn(
              "font-display tracking-tighter italic",
              isProfitable
        ...
        <div className="h-2 bg-white/5 rounded-none overflow-hidden border border-white/5 relative">
          ...
          {!isProfitable && (
            <div
              className="absolute top-0 right-0 h-full w-[1px] bg-white/10"
