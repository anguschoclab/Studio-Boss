...
const colorVariants = {
  ...
  success:
    "from-emerald-500/20 via-emerald-500/5 to-transparent text-emerald-500 border-emerald-500/20",
...
const iconBgVariants = {
  primary:
    "bg-primary/5 text-primary border border-primary/10 shadow-[0_0_40px_rgba(var(--primary),0.2)]",
  secondary:
    "bg-secondary/5 text-secondary border border-secondary/10 shadow-[0_0_40px_rgba(var(--secondary),0.2)]",
  success:
    "bg-emerald-500/5 text-emerald-500 border border-emerald-500/10 shadow-[0_0_40px_rgba(16,185,129,0.2)]",
  destructive:
    "bg-rose-500/5 text-rose-500 border border-rose-500/10 shadow-[0_0_40px_rgba(244,63,94,0.2)]",
  warning:
    "bg-amber-400/5 text-amber-400 border border-amber-400/10 shadow-[0_0_40px_rgba(251,191,36,0.2)]",
  ...
  return (
    ...
    >
      ...
      <CardContent className={cn("relative z-10 p-0", sizes.card)}>
          ...
          <div className="flex-1 min-w-0 space-y-8">
            ...
            <div className="flex flex-col gap-6">
              ...
              {trend && (
                <div
                  className={cn(
                    "flex items-center gap-3 px-4 py-2 bg-white/[0.02] border border-white/5 rounded-none w-fit shadow-2xl",
                    trendColor
                  )}
                >
        ...
        {children && <div className="mt-14 pt-14 border-t border-white/5">{children}</div>}
      </CardContent>
    </Card>
  );
};
