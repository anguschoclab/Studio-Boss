...
export const HandshakeIcon = (props: IconProps) => (
  <Base_Icon_Wrapper {...props}>
    <path d="m11 17 2 2 1.5-1.5" />
    <path d="m9 14 2 2 6-6" />
    <path d="M11 17 9 15" />
    <path d="m18 10 1-1" />
...
export const LogOutIcon = (props: IconProps) => (
  <Base_Icon_Wrapper {...props}>
    <path d="M9 21H5a0 0 0 0 1-2-2V5a0 0 0 0 1 2-2h4" />
...
export const SaveIcon = (props: IconProps) => (
  <Base_Icon_Wrapper {...props}>
    <path d="M19 21H5a0 0 0 0 1-2-2V5a0 0 0 0 1 2-2h11l5 5v11a0 0 0 0 1-2 2z" />
...
export const AlertTriangleIcon = (props: IconProps) => (
  <Base_Icon_Wrapper {...props}>
    <path d="m21.73 18-8-14a0 0 0 0 0-3.48 0l-8 14A0 0 0 0 0 4 21h16a0 0 0 0 0 1.73-3Z" />
