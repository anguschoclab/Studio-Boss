          ...
          {releasedProjects.length > 0 ? (
            releasedProjects.slice(0, 8).map((p) => {
              ...
              return (
                <div
                  key={p.id}
                  className="p-5 flex flex-col gap-3 hover:bg-muted/10 transition-colors group relative overflow-hidden"
                >
                  ...
                  <div className="space-y-1.5 relative z-10">
                    <TooltipWrapper
                      tooltip="Total project earnings from box office receipts, distribution deals, and licensing."
                      side="bottom"
                    >
                    ...
                    <TooltipWrapper
                      tooltip="Total project expenditure including production budget, marketing spend, and talent fees."
                      side="bottom"
                    >
                      <div className="flex justify-between text-[11px] font-medium cursor-help">
                        <span className="text-muted-foreground uppercase tracking-wider text-[9px] font-bold">
                    ...
                    <TooltipWrapper
                      tooltip="Return on Investment ratio. Values above 1.0x signify capital growth."
                      side="top"
                    >
                      <div className="mt-3 pt-3 border-t border-border/30 flex justify-between items-center group-hover:border-primary/20 transition-colors cursor-help">
                        ...
                        <span
                          className={`text-xl font-display font-black drop-shadow-sm ${isProfitable ? "text-success" : "text-destructive"}`}
                        >
                          {roi.toFixed(2)}x
                        </span>
                      </div>
