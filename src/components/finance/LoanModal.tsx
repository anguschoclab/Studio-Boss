...
export const LoanModal = () => {
  ...
  const addLoan = useGameStore((s) => (s as unknown as { addLoan: (amount: number, termWeeks: number) => void }).addLoan);
  const repayLoanEarly = useGameStore((s) => (s as unknown as { repayLoanEarly: (id: string) => void }).repayLoanEarly);
