    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <Card className="glass-card p-12 overflow-hidden group">
        ...
        <div className="relative z-10 flex items-center justify-between mb-12">
          ...
          <div className="text-right">
            <p className="text-6xl font-display font-black tracking-tighter italic text-foreground leading-none">
              {overallRecoupment.toFixed(1)}%
            </p>
            <p className="text-[9px] font-black uppercase tracking-[0.4em] text-muted-foreground/20 italic mt-3">
        ...
        <div className="h-2 bg-white/5 rounded-none overflow-hidden mb-12 relative z-10">
          <div
            className={cn(
              ...
              overallRecoupment >= 100
                ? "bg-emerald-400"
                : overallRecoupment >= 75
                  ? "bg-primary"
                  : overallRecoupment >= 50
                    ? "bg-amber-400"
                    : "bg-red-400"
            )}
        ...
        <div className="grid grid-cols-4 gap-8 text-center relative z-10">
          <div className="space-y-3">
            <p className="text-4xl font-display font-black text-emerald-400 italic leading-none">
              {profitable.length}
            </p>
          ...
          <div className="space-y-3">
            <p className="text-4xl font-display font-black text-primary italic leading-none">
              {recouped.length}
            </p>
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground/20 italic">
              RECOUPED
          ...
          <div className="space-y-3">
            <p className="text-4xl font-display font-black text-amber-400 italic leading-none">
              {inProgress.length}
            </p>
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground/20 italic">
              IN PROGRESS
          ...
          <div className="space-y-3">
            <p className="text-4xl font-display font-black text-red-400 italic leading-none">
              {atRisk.length}
            </p>
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-muted-foreground/20 italic">
              AT RISK
      ...
      {atRisk.length > 0 && (
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-xs font-display font-black uppercase tracking-[0.3em] italic text-red-400">
              At Risk Assets // Yield Deficit
            </h3>
          </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <h4 className="font-display font-black text-lg uppercase tracking-tighter italic leading-none mb-2">
                  ...
                  <div className="text-right">
                    <p className="text-3xl font-display font-black text-red-400 italic leading-none">
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h3 className="text-xs font-display font-black uppercase tracking-[0.3em] italic text-foreground">
            Operational Performance // Yield Audit
          </h3>
        </div>
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-6">
                  {getStatusIcon(project.status)}
                  <div>
                    <h4 className="font-display font-black text-xl uppercase tracking-tighter italic leading-none mb-3">
                      {project.projectTitle}
                    </h4>
                    <div className="flex items-center gap-4">
                      <Badge
                        variant="outline"
                        className="text-[8px] font-black tracking-[0.2em] uppercase rounded-none border-white/5 h-5 px-2 text-muted-foreground/40"
                      >
                        {project.format}
                      </Badge>
