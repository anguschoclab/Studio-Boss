      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
          ...
          >
            ...
            <div
              className={cn(
                "flex items-center p-8 border-b border-white/5 bg-white/[0.01]",
                showCloseButton && !preventClose ? "justify-between" : ""
              )}
            >
            ...
            {/* Footer */}
            {footer && <div className="p-8 border-t border-white/5 bg-black/40">{footer}</div>}
          </m.div>
        </div>
      )}
    </AnimatePresence>
