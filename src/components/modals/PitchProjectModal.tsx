                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Est. Fit: {Math.round(fitScore)}/100
                    </p>
                  </button>
                );
              })}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Buyer fully funds production (0 weekly cost). Studio retains 0% backend. Harder to
                  sell.
                </p>
              </button>
            ...
            <div className="pt-6">
              ...
              {feedback && (
                <p
                  className={`mt-4 text-center text-sm font-semibold ${feedback.includes("Failed") ? "text-destructive" : "text-success"}`}
                >
                  {feedback}
                </p>
              )}
