      ...
      <DialogContent className="max-w-xl bg-black/95 backdrop-blur-3xl border border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.9)] p-0 rounded-none overflow-hidden">
        ...
        <div className="p-10 pb-8 space-y-6 border-b border-white/5 bg-gradient-to-br from-white/[0.02] to-transparent relative">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div
                className={cn(
                  "px-4 py-1 text-[9px] font-black uppercase tracking-[0.4em] border rounded-none italic shadow-2xl",
                  style.color
                )}
              >
                {style.label}
              ...
              <span className="text-[10px] font-black font-mono text-muted-foreground/40 italic tracking-widest uppercase">
                CYCLE W{headline.week} UPLINK
              </span>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-[11px] font-black uppercase tracking-[0.3em] text-primary italic">
              THE TRADES // EXCLUSIVE INTEL STREAM
            </p>
          </div>
        </div>
        ...
        <div className="p-8 border-t border-white/5 flex justify-end bg-black/40">
          ...
          >
            ...
            <ArrowRight
              aria-hidden="true"
              className="h-4 w-4 group-hover:translate-x-2 transition-transform duration-700"
            />
          </button>
        </div>
      </DialogContent>
