    ...
    <div className="h-full flex flex-col animate-in fade-in slide-in-from-bottom-8 duration-1000 space-y-12 pb-20">
      ...
      <div className="flex items-center gap-10 border-b border-white/5 pb-12">
        ...
        <div className="space-y-3">
          <h2 className="text-7xl font-display font-black tracking-tighter uppercase italic leading-none drop-shadow-[0_0_30px_rgba(255,255,255,0.1)]">HUMAN CAPITAL</h2>
      ...
      <Tabs defaultValue="roster" className="flex-1 flex flex-col overflow-hidden">
        <TabsList className="w-fit bg-white/[0.02] border border-white/5 mb-12 p-1 h-16 rounded-none">
          <TabsTrigger value="roster" className="gap-6 h-14 px-12 font-display font-black uppercase tracking-[0.3em] text-[10px] data-[state=active]:bg-secondary data-[state=active]:text-black transition-all duration-700 rounded-none italic">
            <Star className="h-4 w-4" /> YOUR ROSTER
          </TabsTrigger>
          <TabsTrigger value="sbdb" className="gap-6 h-14 px-12 font-display font-black uppercase tracking-[0.3em] text-[10px] data-[state=active]:bg-primary data-[state=active]:text-black transition-all duration-700 rounded-none italic">
            <Database className="h-4 w-4" /> INDUSTRY SBDB
          </TabsTrigger>
        </TabsList>

        {/* YOUR ROSTER */}
        <TabsContent value="roster" className="flex-1 flex flex-col overflow-hidden mt-0 outline-none animate-in fade-in duration-1000">
            ...
            <div className="flex items-center gap-6 w-full md:w-auto">
              <Select value={roleFilter} onValueChange={setRoleFilter}>
                ...
                <SelectContent className="bg-black/95 backdrop-blur-3xl border-white/10 rounded-none">
                  <SelectItem value="all" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">ALL ROLES</SelectItem>
                  <SelectItem value="actor" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">ACTORS</SelectItem>
                  <SelectItem value="director" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">DIRECTORS</SelectItem>
                  <SelectItem value="writer" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">WRITERS</SelectItem>
                  <SelectItem value="producer" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">PRODUCERS</SelectItem>
                </SelectContent>
              </Select>
              <Select value={tierFilter} onValueChange={setTierFilter}>
                ...
                <SelectContent className="bg-black/95 backdrop-blur-3xl border-white/10 rounded-none">
                  <SelectItem value="all" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">ALL TIERS</SelectItem>
                  <SelectItem value="a-list" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">A-LIST (80+)</SelectItem>
                  <SelectItem value="b-list" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">B-LIST (60-79)</SelectItem>
                  <SelectItem value="rising" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">RISING STAR (40-59)</SelectItem>
                  <SelectItem value="undiscovered" className="text-[10px] font-black uppercase tracking-[0.3em] italic focus:bg-primary focus:text-black">NEW TALENT (&lt;40)</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
            ...
            {filteredSBDB.length === 0 && (
              <div className="py-48 flex flex-col items-center text-center space-y-10 opacity-20">
                ...
                <div className="space-y-4 px-12">
                  <p className="text-sm font-black uppercase tracking-[0.6em] italic">NO RECORDS FOUND</p>
                  <p className="text-xs font-black uppercase tracking-[0.3em] leading-relaxed max-w-[400px]">YOUR SURVEILLANCE FILTERS RETURNED ZERO MATCHES FROM THE INDUSTRY DATABASE.</p>
                </div>
              </div>
            )}
          </ScrollArea>
