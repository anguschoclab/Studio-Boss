...
import { Tv, Minus, BarChart3, Radio, Clock, Trophy, ArrowUp, ArrowDown, Activity, Zap } from 'lucide-react';
...
export const NielsenDashboard = () => {
  ...
  const tvShows = React.useMemo(() => 
    projects.filter((p: Project): p is SeriesProject => 
      p.type === 'SERIES' && 'tvDetails' in p && !!(p as unknown as { nielsenProfile?: NielsenProfile }).nielsenProfile
    ),
  [projects]);
