...
const ARCHETYPE_CONFIG = {
  streamer: {
    ...
    tooltip:
      "Global digital distribution platform focusing on subscriber growth and library depth.",
  },
  network: {
    icon: Radio,
    label: "Network",
    ...
    tooltip: "Traditional broadcast or cable network focusing on domestic reach and advertising.",
  },
  premium: {
    icon: Crown,
    label: "Premium",
    ...
    tooltip:
      "High-end subscription service focusing on prestige content and exclusive talent deals.",
  },
} as const;
...
export const PlatformCard: React.FC<PlatformCardProps> = ({
  ...
  const lastSubCount =
    history.length > 1 ? history[history.length - 2].count : streamer.subscribers;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 relative z-10">
        <div className="flex items-center gap-3">
          <TooltipWrapper tooltip={config.tooltip} side="top">
            <div
              className={cn(
                "w-10 h-10 rounded-none flex items-center justify-center border shadow-inner cursor-help",
                config.bg,
                config.border
              )}
            >
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mt-1">
              <Badge
                variant="outline"
                className={cn(
                  "text-[9px] font-black tracking-widest uppercase px-1.5 py-0 h-4 border-none",
                  config.bg,
                  config.color
                )}
              >
              ...
              {isAcquired && (
                <Badge
                  variant="outline"
                  className="text-[8px] font-black tracking-widest uppercase px-1.5 py-0 h-4 bg-white/5 border-white/5 text-muted-foreground/60 leading-none"
                >
        ...
        {buyer.currentMandate && (
          <TooltipWrapper
            tooltip="The primary strategic goal for this platform. Alignment increases the probability of deal acceptance and higher valuations."
            side="left"
          >
            <div className="flex flex-col items-end cursor-help">
              <span className="text-[7px] font-black text-muted-foreground/40 uppercase tracking-[0.2em] mb-1">
                Active Mandate
              </span>
              <Badge
                variant="secondary"
                className="text-[9px] font-bold uppercase tracking-widest bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2"
              >
      ...
      {isStreamer && (
        <TooltipWrapper
          tooltip="Subscriber trajectory over the last 12 weeks. Trends influence platform valuation and buying power."
          side="top"
        >
      ...
      >
        {buyer.archetype === "streamer" && (
          <TooltipWrapper
            tooltip="Total number of paying users on this digital network."
            side="bottom"
          >
            <div className="space-y-1 cursor-help">
              <div className="text-[9px] uppercase font-black tracking-widest text-muted-foreground/40 leading-none">
                Global Subs
              </div>
        ...
        {buyer.archetype === "network" && (
          <TooltipWrapper
            tooltip="Estimated percentage of households reached by this broadcast network."
            side="bottom"
          >
            <div className="space-y-1 cursor-help">
              <div className="text-[9px] uppercase font-black tracking-widest text-muted-foreground/40 leading-none">
        ...
        <TooltipWrapper
          tooltip="Market capitalization and competitive influence index. Higher strength equals better deal terms."
          side="bottom"
        >
          <div className="space-y-1 cursor-help">
            <div className="text-[9px] uppercase font-black tracking-widest text-muted-foreground/40 leading-none">
      ...
      {buyer.isAcquirable && !isAcquired && (
        <TooltipWrapper
          tooltip="This platform is currently vulnerable to a corporate takeover."
          side="top"
        >
