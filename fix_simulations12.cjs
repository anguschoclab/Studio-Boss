...
code = code.replace(/import \{ getMarketHeat, getBudgetInflation \} from '\.\.\/systems\/industry\/MacroCycle';/g, "import { getBudgetInflation } from '../systems/industry/MacroCycle';");
